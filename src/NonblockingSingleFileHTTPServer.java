...
public class NonblockingSingleFileHTTPServer {
    ...
    private HashMap<String, HttpRequestManager> reqCache = new HashMap<String, HttpRequestManager>();
            ...
            while (keys.hasNext()) {
                ...
                try {
                    if (key.isAcceptable()) {
                        ...
                        ByteBuffer readBuffer = ByteBuffer.allocate(9000);
    ...
    private boolean loadHttpServlet(){
        ...
        String servlet       = null;
        Class clazz          = null;
        boolean result       = resource.processForValidResource(servlet);
        if(!result){
           return false;
        }

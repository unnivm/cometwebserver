...
import javax.servlet.http.HttpSession;
 ...
 public class Request {
	...
	public String getParameter(String key){
            ...
            System.out.println(" request map: " + requestMap+ "  "+requestMap.get(key));
	  if(requestMap.get(key.trim())==null) return null;
          
          
	  return requestMap.get(key.trim()).toString();
	}
       ...
       for(Cookie c:cookies){
         if(Constants.JSESSIONID.equals(c.getName())){
             ...
             if(bb == null){ // get it from containser context
                ...
                if(session.getId().equals(c.getValue())){

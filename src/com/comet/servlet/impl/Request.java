...
public HttpSession getSession(){
   if(cookies != null){
       for(Cookie c:cookies){
         if(Constants.JSESSIONID.equals(c.getName())){
           // System.out.println("cometState.getValue() " + cometState.getValue());
            sc = CometUtil.getHttpSession(cometState.getValue().get(context).array());
            if(sc != null){
   ...
   if(session == null){
     //System.out.println(" session is null ...creating new one....."); 

 ...
 public  class HttpServletResponseImpl implements HttpServletResponse {
  ...
  public int getBufferSize(){
   ...
   public PrintWriter getWriter(){
    try {
        myPrintWriter = new CometPrintWriter(response.getOutputStream());
	} catch (IOException e){
	}
   ...
   public void sendRedirect(String location) throws IOException{
    ...
    public String encodeURL(String url) {
        try {
            ...
            Logger.getLogger(HttpServletResponseImpl.class.getName()).log(Level.SEVERE, null, ex);
        }
      return url;
    }
    
    public void setForward(boolean forward,String path){

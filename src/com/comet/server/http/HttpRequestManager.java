 ...
 public final class HttpRequestManager {
   ...
   public void initializeCharBuffer(){
      ...
      decoder = charset.newDecoder();
        ...
        /*
         * Need to refactor the code and move these request related methods to
         * Request object.
         */
    @SuppressWarnings("LoggerStringConcat")
 public final void processHeaderDataFromRequest(final ByteBuffer buffer,final Request request,final Response response,final SocketChannel channel){
       try{
	    ...
	    CharBuffer cb = decoder.decode(buffer);
            logger.log(Level.INFO, " header data " + cb.toString());
	    ...
	    // setting local address
	     ...
	     setOutputStream(response, channel);
             ...
             System.out.println("here time taken: " + (now - start));
	}catch(Exception e){
          Logger.getLogger(HttpRequestManager.class.getName()).log(Level.SEVERE, null, e);
	}
     }

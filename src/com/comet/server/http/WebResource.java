...
public class WebResource {
    ...
    private ArrayList<String> resourceCache = new ArrayList<String>();
   ...
   private boolean isValidResource(Map<String, Object> mapper, final WebXML xml){
        ...
        if(urlmapper.validateURL()){
            ...
            // sets absolute path info
            requestManager.getRequest().setAbsolutePath(urlmapper.getPathTransalated());
